...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //firebaseDatabase.setPersistenceEnabled(true); // Enable offline database
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    // Tao mot nhanh user moi tren firebaseDatabase
                                                    firebaseRef.child("USERS").child(user.getUid()).setValue(newUser);
                    ...
                    firebaseAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                // Start MainActivity when success.
                                Intent listIntent = new Intent(LoginActivity.this, MainActivity.class);
                                startActivity(listIntent);
